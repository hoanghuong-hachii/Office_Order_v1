...
public class VerifiedChangePassActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verified_change_pass);
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful()) {
                    ...
                    Log.e("GET US Verifiedchangepass", "onResponse: "+username );
                } else {
                }
            }
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful()) {
                    ...
                    if(result.equals("Xác minh thành công")){
                        ...
                        showSuccessDialog("Xác thực thành công!");
                    }
                    else {
                        showErrorMessage("OTP không hợp lệ hoặc đã hết hạn, " +
                                "Bạn còn "+failedAttempts +"/"+ MAX_FAILED_ATTEMPTS +" lần. " +
                                "Tài khoản sẽ bị khóa nếu nhập quá số lần cho phép!");
                    }
                } else {
        ...
        builder.setTitle("Thành công")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(VerifiedChangePassActivity.this, ChangePassActivity.class);
